...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="dd1_Area" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
            <asp:ListItem>北區</asp:ListItem>
            <asp:ListItem>中區</asp:ListItem>
        </asp:DropDownList>
        <br />
        <asp:DropDownList ID="dd1_Place" runat="server">
        ...
        <br />
        <asp:RadioButtonList ID="rb1_Res" runat="server">
        ...
        <br />
        <br />
        <asp:Label ID="Ib_Msg" runat="server"></asp:Label>
    </form>
</body>
</html>
